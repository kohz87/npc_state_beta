...
const SYSTEM_PROMPT = 'Return only valid JSON for the NPC State v0.4.43 recovery scanner. Obey the supplied schema and evidence rules exactly.';
...
// PHASE64_REBASE_STATE_BOUNDARIES: accepted preserve-rebase history cannot be scored again after refresh failure/reload.
...
export function createNpcStateEngine(adapters = {}) {
    ...
    if (typeof getContext !== 'function' || typeof getChatKey !== 'function' || typeof getSettings !== 'function' || typeof generate !== 'function') {
        throw new Error('NPC State v0.4.43 engine requires getContext, getChatKey, getSettings, and generate adapters.');
    }
    ...
    async function loadChat(chatKey = getChatKey()) {
        ...
        try {
            ...
            if (importedStable || fingerprintUpgraded || recoveryInterrupted) {
                ...
                if (importedStable) {
                    notify('success', 'Cloned stable NPC State v0.3 dossiers into an independent v0.4.43 beta sidecar. Stable data was not modified.');
