...
const SYSTEM_PROMPT = 'Return only valid JSON for the NPC State v0.4.9 recovery scanner. Obey the supplied schema and evidence rules exactly.';
...
export function createNpcStateEngine(adapters = {}) {
    ...
    if (typeof getContext !== 'function' || typeof getChatKey !== 'function' || typeof getSettings !== 'function' || typeof generate !== 'function') {
        throw new Error('NPC State v0.4.9 engine requires getContext, getChatKey, getSettings, and generate adapters.');
    }
    ...
    async function loadChat(chatKey = getChatKey()) {
        ...
        try {
            ...
            if (importedStable || fingerprintUpgraded) {
                ...
                if (importedStable) {
                    notify('success', 'Cloned stable NPC State v0.3 dossiers into an independent v0.4.9 beta sidecar. Stable data was not modified.');
