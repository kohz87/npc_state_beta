...
export function dossierExtractionPromptRules({ includeNew = true, includeExisting = true } = {}) {
    ...
    return [
        ...
        'PROFILE CONSOLIDATION: keep behaviorProfile/mannerisms compact; merge substantial overlap while preserving distinct facts/scope, unrelated entries, and ownership. Targeted shapes are below; one-off gestures may remain observations.',
