...
export function dossierExtractionPromptRules({ includeNew = true, includeExisting = true } = {}) {
    ...
    return [
        ...
        'BEHAVIOR PROFILE EVIDENCE: personality/behaviorProfile describe characteristic choices and routines; mannerisms describe recurring expressive gestures. Explicit characterization or multiple reinforcing actions may establish a narrow pattern within one scene. Reconsider supplied observations with new current support. Isolated gestures and unrelated actions stay observations; continued narration of one action is not independent recurrence. Encounter count alone never qualifies.',
        ...
        'PROFILE DEVELOPMENT: establishing blanks and enriching compatible detail do not require character transformation. Refine supported patterns before marking unchanged. Contradictory lasting change needs explicit sustained development or independent observations plus new support; elapsed time or temporary mood/sleep/injury/stress/silence is insufficient. In routine scans, saved observations are context: cite new current excerpts, never replay old sources. Player-specific attitude belongs in Current Dynamic.',
