...
if (!source.includes(oldHeader)) throw new Error('Missing legacy 0.4.5 injection-header assertion');
...
if (!source.includes(oldManifest)) throw new Error('Missing legacy 0.4.5 manifest assertion');
