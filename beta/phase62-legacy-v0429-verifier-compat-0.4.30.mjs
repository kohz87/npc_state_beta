...

{
    ...
    source = replaceCompat(
        ...
        'v0.4.29 README title',
    );
    source = replaceCompat(
        source,
        "console.log('NPC State 0.4.29 release source parity verified');",
        "console.log('NPC State 0.4.29+ release source parity verified');",
        'v0.4.29 verifier label',
    );
    fs.writeFileSync(path, source);
}

console.log('Made v0.4.28/v0.4.29 release parity verifiers forward-compatible with v0.4.30');
