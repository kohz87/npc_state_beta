...
assert(/^0\.4\.(?:4[1-9]|[5-9]\d|\d{3,})$/.test(manifest.version), 'Manifest must be v0.4.41+');
assert(/name: Build NPC State 0\.4\.(?:4[1-9]|[5-9]\d|\d{3,}) Beta/.test(workflow), 'Workflow title must be v0.4.41+');
assert(/for patch in \$\(seq 2 (?:4[1-9]|[5-9]\d|\d{3,})\); do/.test(workflow), 'Cold replay must include patch 41 or later');
